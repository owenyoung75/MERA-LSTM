...
class HomoPolyMERA_RNNCell(RNNCell):
    def __init__(self,
                 num_hidden_units,
                 num_lags,
                 num_orders,
    ...
    def __call__(self, inputs, states):
        ...
        new_h = Homo_PolyMERA_wavefn(inputs,
                                     states,
                                     self.output_size,
                                     self._num_orders,
                                     self._virtual_dim,
...
class HomoPolyMERA_LSTMCell(RNNCell):
    ...
    def __call__(self, inputs, states):
        ...
        concat = Homo_PolyMERA_wavefn(inputs,
                                      hs,
                                      meta_variable_size,
                                      self._num_orders,
                                      self._virtual_dim,
...
def Homo_PolyMERA_wavefn(inputs,
                         states,
                         meta_size,
                         num_orders,
                         virtual_dim,
    ...
    state_tensor = _list_to_tensor(batch_size, lattice)
